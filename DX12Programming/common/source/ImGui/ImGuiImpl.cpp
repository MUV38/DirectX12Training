...
// 描画
void ImGuiImpl::RenderDrawData(ImDrawData* draw_data, ID3D12GraphicsCommandList* ctx)
{
...
bool ImGuiImpl::InitWin32(HWND* hWnd)
{
...
// シャットダウン
void ImGuiImpl::ShutdownCommon()
{
	ImGui::DestroyContext();
}
void ImGuiImpl::ShutdownWin32()
{
	m_hWnd = nullptr;
}
void ImGuiImpl::ShutdownDx12()
{
...
// フレーム開始
void ImGuiImpl::NewFrameCommon()
{
	ImGui::NewFrame();
}
void ImGuiImpl::NewFrameWin32()
{
	ImGuiIO& io = ImGui::GetIO();
...
void ImGuiImpl::SetupRenderState(ImDrawData* draw_data, ID3D12GraphicsCommandList* ctx, FrameResources* fr)
{
...
bool ImGuiImpl::UpdateMouseCursor()
{
	ImGuiIO& io = ImGui::GetIO();
